...
> [!NOTE]
> В настоящее время мы изучаем проблему, из-за которой недоступны события с типом контента Audit.AzureActiveDirectory при использовании API действий управления Office 365. Эта проблема возникла приблизительно 26 октября 2020 г. Эта проблема не влияет на события входа Azure AD. Мы выпустим обновление, когда проблема будет устранена.
