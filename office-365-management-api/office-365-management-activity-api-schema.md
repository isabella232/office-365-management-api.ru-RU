...
|Действие доставки (ожидаемое поле) |Edm.String|Да|Исходное действие доставки сообщения электронной почты.|
|Исходное расположение доставки (ожидаемое поле) |Edm.String|Да|Исходное расположение доставки сообщения электронной почты.|
|Последнее расположение доставки (ожидаемое поле) |Edm.String|Да|Последнее расположение доставки сообщения электронной почты во время события.|
|Направление (ожидаемое поле) |Edm.String|Да|Определяет, было ли сообщение электронной почты входящим, исходящим или сообщением внутри организации.|
|ThreatsAndDetectionTech (ожидаемое поле) |Edm.String|Да|Угрозы и соответствующие технологии обнаружения. В этом поле указываются все угрозы в сообщении электронной почты, включая последнее добавление решения о спаме.  Например, ["Фишинг: [спуфинг DMARC]","Спам: [репутация вредоносного URL-адреса]"]. Ниже описаны различные технологии обнаружения угроз.|
|||||
