...
|50|ексчанжеитемаггрегатед|События, связанные с [действием аудита почтового ящика маилитемсакцессед](https://docs.microsoft.com/microsoft-365/compliance/mailitemsaccessed-forensics-investigations).|
...
|3 |Просмотреть|Пользователь просматривает клиент Sway.|
...
|11 |DisableDuplication|Пользователь отключает дублирование клиента Sway (отключено по умолчанию).|
