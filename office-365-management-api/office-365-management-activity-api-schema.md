...
|29|MailSubmission|События отправки из Exchange Online Protection и Office 365 Advanced Threat Protection.|
...
|**Значение**|**Имя элемента**|**Описание**|
|:-----|:-----|:-----|
|0|SwayWeb|Событие активировано с помощью веб-клиента Sway.|
...
|**Значение**|**Имя элемента**|**Описание**|
|:-----|:-----|:-----|
|1|Create|Пользователь создает клиент Sway.|
