...
|Поле  |Тип   |Описание   |
|----|----|----|
|Тип   |Edm.String |"MailCluster" <br/>Определяет тип обсуждаемого объекта |
...
#### <a name="sample-audit-record"></a>Пример записи аудита
